...
function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#f3f3f3] flex flex-col">
      ...
      `}
              >
                <div className="flex items-center justify-center w-14 h-14 rounded-2xl bg-green-50 text-green-600 mb-6">
                  {item.icon}
                </div>

                <p className="text-xs font-semibold tracking-widest text-green-600 mb-2">
                  {item.step}
                </p>
            ...
            <div className="grid md:grid-cols-2 gap-10">
              {[
                ...
                },
                {
                  ...
                  desc: "Unlock premium interview sessions and advanced features.",
                },
              ].map((mode, index) => (
                <motion.div
                  key={index}
