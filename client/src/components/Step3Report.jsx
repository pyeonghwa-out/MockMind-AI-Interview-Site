  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-green-50 px-4 sm:px-6 lg:px-10 py-8">
      <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <button className="bg-emerald-600 hover:bg-emerald-700 text-white py-3 px-2 rounded-xl shadow-md transition-all duration-300 font-semibold text-sm sm:text-base text-nowrap" onClick={downloadPDF}>
          Download PDF
        </button>
      </div>
